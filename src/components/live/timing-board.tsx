        ...
        <tbody>
          {entries.map((entry, idx) => {
            ...
            return (
              ...
              >
                <td className={cn("sticky left-0 z-10 bg-f1-bg group-hover:bg-f1-card/50 transition-colors px-2 py-2 text-center font-bold", inKnockoutZone && "!bg-red-500/5 text-red-400/80")}>
                  {isOut ? (
                ...
                <td className={cn("sticky left-10 z-10 bg-f1-bg group-hover:bg-f1-card/50 transition-colors px-2 py-2 whitespace-nowrap", inKnockoutZone && "!bg-red-500/5")}>
